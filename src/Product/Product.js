...
export const Product = () => {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
    >
      <div className="project-page product">
        ...
        <img src="/illustration9.png" style={{ maxWidth: 400 }} />
        <p>The final 404 illustration. People love animals.</p>
        <svg
          class="img"
          width="783"
          height="574"
